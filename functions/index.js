...
- Verwende, wo es natürlich passt, typische verbindende und einordnende Wendungen der Zeugnissprache (z. B. "insgesamt", "ebenso", "ebenfalls", "teilweise", "zusätzlich" – nur beispielhaft, nicht abschließend), damit der Text flüssig und authentisch klingt. Wenn in den Beobachtungen jedoch eine Häufigkeit oder Schwere genannt ist (z. B. "massiv", "regelmäßig", "gezielt"), übernimm sie genau und schwäche sie nicht durch solche Wendungen ab. Nur wo zu Häufigkeit oder Schwere nichts angegeben ist, darfst du diese Wendungen frei einsetzen.
