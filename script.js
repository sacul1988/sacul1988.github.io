    ...
    if (searchContainer) {
        ...
        if (!isVisible) {
            ...
            if (input) {
                ...
                // Tasten-Event-Listener hinzufügen (Enter, Pfeil oben/unten)
                if (!input.dataset.keyListenerAdded) {
                    input.addEventListener('keydown', (e) => {
                        ...
                        if (e.key === 'Enter') {
                            ...
                            e.preventDefault();
                            if (activeIndex >= 0) items[activeIndex].classList.remove('active-suggestion');
                    ...
                    input.dataset.keyListenerAdded = "true";
                }
    ...
    classes[activeClassId].students.forEach((student, index) => {
        ...
        card.innerHTML = `
            <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <button class="btn btn-sm btn-light" onclick="window.scrollTo(0,0); document.documentElement.scrollTop = 0; document.body.scrollTop = 0;">
