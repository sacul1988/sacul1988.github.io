...
function saveData() {
    try {
        ...
        // Sicherstellen, dass AppState und globale Variablen synchron sind
        if (AppState) AppState.classes = classes;
        ...
        if (oralWeightElement) {
            ...
            if (AppState) AppState.oralWeight = safeParseInt(oralWeightElement.innerText, 50);
        }
