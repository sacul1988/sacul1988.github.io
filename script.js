...
function renderClassesGrid() {
    ...
    tpCard.innerHTML = `
        <div class="class-card-header tp-header">
...
function ztPlanungCourseCardHtml(course) {
    ...
    // Status der ganzen Karte:
    // grün = fertig (alle erledigt) ODER jemand anderes zuständig
    // orange = ich bin zuständig (noch nicht fertig)
    // grau (Basis) = noch nicht geklärt / niemand zugewiesen
    ...
    else if (responsible === 'me') courseStatusClass = 'zt-course-open';
    ...
    modal.innerHTML = `
        ...
        <div class="zt-plan-form">
            ...
            <div class="form-group zt-plan-form-usit" style="${isSozial ? 'display:none;' : ''}">
                <label for="zt-plan-form-usit">Unterrichtssituation und verwendete Unterrichtsmaterialien</label>
