...
async function zeugnisnoteGenerate(index, richtung, customMessages = null) {
    ...
    if (!activeMessages) {
        ...
        if (fachart === "nebenfach") {
            ...
            userMsg += `1. Der ERSTE Stichpunkt des mitarbeit_text (also direkt nach der Auflistung der schriftlichen Noten und der Durchschnittsnote) muss der Gewichtungshinweis sein, wörtlich (setze für FACH nur den Namen des Unterrichtsfachs ein, z. B. Musik – ohne Klassen- oder Jahrgangsangabe): "• Im Nebenfach FACH zählt deine mündliche Mitarbeit, deine Arbeitshaltung und deine Motivation jedoch insgesamt deutlich mehr als die schriftlichen Noten." Erst danach folgen die Stichpunkte zu den Beobachtungen, und ganz zum Schluss der Satz mit der Endnote.\n`;
